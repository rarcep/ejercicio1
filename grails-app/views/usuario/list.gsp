...
<%@ page import="ejercicio1.Usuario" %>
<!doctype html>
<html>
	<head>
			...
			<table>
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(type: usuarioInstance, field: "password",)}</td>
						...
						<td><g:formatDate format="dd/MM/yyyy" date="${usuarioInstance?.fechaNacimiento}"/></td>
